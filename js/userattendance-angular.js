...
app.controller('memberdata',function($scope, $http, $window){
    ...
    $scope.fetch = function(){
    	$http.get("user-attendance-fetch.php").success(function(data){ 
	        $scope.members = data; 
	    });
    }
    ...
    $scope.updateMember = function(){
    	$http.post("user-attendance-edit.php", $scope.clickMember)
    	.success(function(data) {
        	if(data.error){
        		$scope.error = true;
        		$scope.errorMessage = data.message;
    ...
    $scope.deleteMember = function(){
    	$http.post("user-attendance-delete.php", $scope.clickMember)
    	.success(function(data) {
        	if(data.error){
        		$scope.error = true;
        		$scope.errorMessage = data.message;
