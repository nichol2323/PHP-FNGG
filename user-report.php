...
?>
	...
	<body ng-controller="memberdata" ng-init="fetch()">
		...
		<div class="container-fluid">
			...
			<h1 id="title" class="page-header text-center">Personal Payroll Report</h1>
					...
					<table class="table table-bordered table-striped" style="margin-top:10px;">
						<thead>
							<tr>
								...
								<th ng-click="sort('deduction')" class="text-center">Deduction
									<span class="pull-right">
			...
			<?php include('user-report-modal.php'); ?>
		</div>
		<script src="js/dirPaginate.js"></script>
		<script src="js/user-report-angular.js"></script>
	</body>
