...
<div class="container-fluid">
    <h1 class="page-header text-center">Payroll List</h1>
    <div class="row">
			...
			<table class="table table-bordered table-striped" style="margin-top:10px;">
				...
				<tbody>
					<tr dir-paginate="member in members|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
						...
						<td>
						<button type="button" class="btn btn-success" ng-click="showEdit(); selectMember(member);"><i class="fa fa-edit"></i> Payroll</button> 
						</td>
	...
	<?php include('payroll-manage-modal.php'); ?>
</div>
<script src="js/dirPaginate.js"></script>
<script src="js/payroll-manage-angular.js"></script>
</body>
</html>
<?php
} else {
