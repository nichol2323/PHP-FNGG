...
if (
	...
	'<center>error!</center>' . '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
		...
		if (mysqli_num_rows($result) > 0) {
			...
			$sql2 = "INSERT INTO admin(user_name, password, name, type) VALUES('$uname', '$pass', '$name', 'admin')";
